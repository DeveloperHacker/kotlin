...
public class ParsingTestGenerated extends AbstractParsingTest {
    ...
    public static class Psi extends AbstractParsingTest {
        ...
        @TestMetadata("compiler/testData/psi/patternMatching")
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class PatternMatching extends AbstractParsingTest {
            public void testAllFilesPresentInPatternMatching() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/psi/patternMatching"), Pattern.compile("^(.*)\\.kts?$"), TargetBackend.ANY, true);
            }

            @TestMetadata("expressionRecognition.kt")
            public void testExpressionRecognition() throws Exception {
                String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/psi/patternMatching/expressionRecognition.kt");
                doParsingTest(fileName);
            }
