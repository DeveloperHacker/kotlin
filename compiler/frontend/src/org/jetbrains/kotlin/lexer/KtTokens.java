...
public interface KtTokens {
    ...
    KtKeywordToken LIKE_KEYWORD        = KtKeywordToken.softKeyword("like");
    ...
    KtModifierKeywordToken DECONSTRUCTOR_KEYWORD = KtModifierKeywordToken.softKeywordModifier("deconstructor");
    ...
    TokenSet SOFT_KEYWORDS = TokenSet.create(FILE_KEYWORD, IMPORT_KEYWORD, WHERE_KEYWORD, BY_KEYWORD, GET_KEYWORD,
                                             ...
                                             EQ_KEYWORD, LIKE_KEYWORD, DECONSTRUCTOR_KEYWORD
    );
    ...
    KtModifierKeywordToken[] MODIFIER_KEYWORDS_ARRAY =
            new KtModifierKeywordToken[] {
                    ...
                    HEADER_KEYWORD, IMPL_KEYWORD, EXPECT_KEYWORD, ACTUAL_KEYWORD, DECONSTRUCTOR_KEYWORD
            };
