...
fun foo(x: Any?, a: Int) = when (x) {
    ...
    is like <!UNRESOLVED_REFERENCE!>pair<!>(val <!NAME_SHADOWING!>a<!> is Int, val b is Int) -> <!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>a<!> <!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>+<!> <!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>b<!>
