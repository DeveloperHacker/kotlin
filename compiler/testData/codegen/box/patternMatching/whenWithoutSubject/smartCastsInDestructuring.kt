...
fun foo(parent: Parent) = when {
    parent is like Child1(val f1) -> parent.field1 + f1
    parent !is like Child2(val _) -> 10
    parent !is like Child2(_) -> 20
    parent is like (val f2) -> parent.field2 + f2
}

fun foo2(parent: Parent) = when {
    parent is like Child1(val f1) && parent.field1 == 1 -> parent.field1 + f1
    parent !is like Child2(val _) -> 10
    parent !is like Child2(_) -> 20
    parent is like (val f2) && parent.field2 == 2 -> parent.field2 + f2
    else -> 30
}
