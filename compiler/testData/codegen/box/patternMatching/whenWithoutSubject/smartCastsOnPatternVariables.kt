...
fun foo(parent: Parent) = when {
    parent is like val child is Child1 -> parent.field1
    parent !is like val _ is Child2 -> 10
    parent is like val child -> parent.field2
}

fun foo2(parent: Parent) = when {
    parent is like val child is Child1 -> child.field1
    parent !is like val _ is Child2 -> 10
    parent is like val child -> child.field2
}

fun foo3(parent: Parent) = when {
    parent is like val child is Child1 && child.field1 == 1 -> child.field1
    parent !is like val _ is Child2 -> 10
    parent is like val child && child.field2 == 2 -> child.field2
    else -> 20
}
