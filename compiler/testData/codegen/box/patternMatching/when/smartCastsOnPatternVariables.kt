...
fun foo(parent: Parent): Int = when(parent) {
    is like val child is Child1 -> parent.field1
    !is like val _ is Child2 -> 10
    is like val child -> parent.field2
}

fun foo2(parent: Parent): Int = when(parent) {
    is like val child is Child1 -> child.field1
    !is like val _ is Child2 -> 10
    is like val child -> child.field2
}

fun foo3(parent: Parent): Int = when(parent) {
    is like val child is Child1 && child.field1 == 1 -> child.field1
    !is like val _ is Child2 -> 10
    is like val child && child.field2 == 2 -> child.field2
    else -> 20
}
